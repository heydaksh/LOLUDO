                      ...
                      children: [
                        ...
                        _buildRuleCard(
                          ...
                          description:
                              ...
                              "❄ Freeze Pulse – Freezes enemy pawns within 5 blocks forward and backward for one turn.\n\n"
                              "🛡 Shield – Makes the pawn uncapturable for 30 seconds. Attackers get eliminated instead.\n\n"
                              "↩ Reverse Move – Allows one backward move using the dice value.\n\n"
                              "🎲 Dice Multiplier – Doubles the next dice result for a single move.\n\n"
                              "🔄 Swap Power – Lets you swap positions with any opponent pawn on the board.",
                        ),
                        _buildRuleCard(
                          ...
                          title: "How to enable ?",
                          description:
                              "Click on the settings icon in the bottom right corner of the screen. Then click on the 'Hacks' button. Then click on the toggle buttons to enable the hacks.",
                        ),
                      ],
                    ),
                  ),
